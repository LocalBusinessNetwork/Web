  ...
  Backbone.RWAuth = RWAuth = (function(Backbone, _, $, rwcore){
        ...
        promise.done(
              function(model, response, jqXHR) {
                  ...
                  if (rwFB.OSType.indexOf("IPHONE") > -1) {
                  	...
                  	rwcore.FYI("Congratulations, Your account has been registered a confirmation email has been sent to your email address.");
    ...
    confirmLogin : function ( event ) {
        ...
        $.when(req).done (function (d) { 
            ...
            rwcore.showError(esponse, status, error)
        });

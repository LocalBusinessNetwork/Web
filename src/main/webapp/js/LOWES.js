(function (root, factory) {
  ...
  Backbone.ReferralWireLOWES = ReferralWireLOWES = (function($, _, Backbone ){
    var ReferralWireLOWES = {} ; 
    
    ReferralWireLOWES.showWelcomePage = function() {
    	var welcomePageTemplate = rwcore.getTemplate('/LOWES/Templates/Views/STN_welcomePage.html');
    ...
    ReferralWireLOWES.Router  = Backbone.ReferralWireRouter.extend({
        initialize: function(options) {
          // this is how you would create custom route for this module
          this.route('rw/test/:id', 'rwtest', this.rwTest);
          this.constructor.__super__.initialize.call(this,options);
          Backbone.ReferralWireBase.Templatecache.StdFormContactPartner = Backbone.rwcore.getTemplate('/LOWES/Templates/Forms/STN_StdFormContactPartner.html');
        ...
        STNBlah : function(id) {
      	...
      	home: function() {
	    	  ...
	    	  var that = this;
			  var homeTemplate = Backbone.rwcore.getTemplate('/LOWES/Templates/Views/STN_HomePageView.html');
		      ...
		      hpModel.fetch({
		          ...
		          success : function (model, response, jqXHR) {
		              ...
		              rwFB.iconDirectory = rwFB.CDN + "/LOWES/Images/";
				 	 ...
				 	 if (rwFB.showWelComePage == 'SHOW') {
				 		...
				 		homeview.welcomeView = ReferralWireLOWES.showWelcomePage();
    ...
    ReferralWireLOWES.PhoneRouter  = Backbone.ReferralWirePhoneRouter.extend({
        initialize: function(options) {
          // this is how you would create custom route for this module
          this.route('rw/test/:id', 'rwtest', this.rwTest);
          this.constructor.__super__.initialize.call(this,options);
        ...
        home : function() {
	        ...
	        var hpModel = new Backbone.ReferralWire.HomePageModel();
	        var that = this;
	        var homeTemplate = Backbone.rwcore.getTemplate('/LOWES/Templates/Phone/STN_phonehome.html');
    ...
    return ReferralWireLOWES;   
  })($, _, Backbone || window.jQuery || window.Zepto || window.ender);
  return Backbone.ReferralWireLOWES; 
}));
